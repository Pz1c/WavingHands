    ...
    QObject(parent)
{
    ...
    Spells.append(new QSpell(13,"DWWFWD","Poison", SPELL_TYPE_POISON,13,1,18, SPELL_DEF_TARGER_ENEMY, 4, true, false, SPELL_GROUP_ADVANCED, 5));
    Spells.append(new QSpell(SPELL_PARALYSIS,"FFF","Paralysis", SPELL_TYPE_CONFUSION,13,2, 20, SPELL_DEF_TARGER_ENEMY, 0, true, true, SPELL_GROUP_DISRUPTIONS, 2));
    Spells.append(new QSpell(15,"WFPSFW","Summon Giant", SPELL_TYPE_SUMMON_MONSTER,17,4,15, SPELL_DEF_TARGER_SELF, 4, true, false, SPELL_GROUP_MONSTERS, 2));
    Spells.append(new QSpell(16,"FPSFW","Summon Troll", SPELL_TYPE_SUMMON_MONSTER,15,3,14, SPELL_DEF_TARGER_SELF, 3, true, false, SPELL_GROUP_MONSTERS, 2));
    Spells.append(new QSpell(17,"PSFW","Summon Ogre", SPELL_TYPE_SUMMON_MONSTER,13,2,13, SPELL_DEF_TARGER_SELF, 2, true, true, SPELL_GROUP_MONSTERS, 2));
    Spells.append(new QSpell(18,"SFW","Summon Goblin", SPELL_TYPE_SUMMON_MONSTER,14,1,12, SPELL_DEF_TARGER_SELF, 1, true, true, SPELL_GROUP_MONSTERS, 1));
    Spells.append(new QSpell(19,"FSSDD","Fireball", SPELL_TYPE_DAMAGE,13,1,15, SPELL_DEF_TARGER_ENEMY, 5, true, false, SPELL_GROUP_DAMAGING, 3));
    Spells.append(new QSpell(20,"P","Shield", SPELL_TYPE_SHIELD,1,0,10, SPELL_DEF_TARGER_SELF, 0, true, true, SPELL_GROUP_PROTECTION, 1));
    Spells.append(new QSpell(21,"PDWP","Remove Enchantment", SPELL_TYPE_REMOVE_ENCHANTMENT,10,0,13, SPELL_DEF_TARGER_SELF, 0, true, false, SPELL_GROUP_COUNTERS, 3));
    Spells.append(new QSpell(22,"PPws","Invisibility", SPELL_TYPE_CONFUSION,13,0,13, SPELL_DEF_TARGER_SELF, 0, true, false, SPELL_GROUP_ADVANCED, 3));
    Spells.append(new QSpell(23,"PSDD","Charm Monster", SPELL_TYPE_CHARM_MONSTER,10,0,12, SPELL_DEF_TARGER_ENEMY_MONSTER, 0, true, true, SPELL_GROUP_DISRUPTIONS, 2));
    Spells.append(new QSpell(24,"PSDF","Charm Person", SPELL_TYPE_CONFUSION,15,4,13, SPELL_DEF_TARGER_ENEMY, 0, true, true, SPELL_GROUP_DISRUPTIONS, 2));
    Spells.append(new QSpell(25,"PWPFSSSD","Finger of Death", SPELL_TYPE_DAMAGE,11,0,20, SPELL_DEF_TARGER_ENEMY, 20, true, false, SPELL_GROUP_DAMAGING, 5));
    Spells.append(new QSpell(26,"PWPWWc","Haste", SPELL_TYPE_HASTLE,12,0,10, SPELL_DEF_TARGER_SELF, 0, true, false, SPELL_GROUP_ADVANCED, 5));
    Spells.append(new QSpell(27,"SD","Magic Missile", SPELL_TYPE_DAMAGE,10,0,10, SPELL_DEF_TARGER_ENEMY, 1, true, true, SPELL_GROUP_DAMAGING, 1));
    Spells.append(new QSpell(SPELL_ANTI_SPELL,"SPFP","Anti-spell", SPELL_TYPE_CONFUSION,13,0,14, SPELL_DEF_TARGER_ENEMY, 5, true, false, SPELL_GROUP_DISRUPTIONS, 3));
    Spells.append(new QSpell(29,"SPFPSDW","Permanency", SPELL_TYPE_SPEC,13,0,16, SPELL_DEF_TARGER_SELF, 0, true, false, SPELL_GROUP_ADVANCED, 5));
    ...
    Spells.append(new QSpell(37,"WPFD","Cause Heavy Wounds", SPELL_TYPE_DAMAGE,13,0,13, SPELL_DEF_TARGER_ENEMY, 3, true, true, SPELL_GROUP_DAMAGING, 1));
    Spells.append(new QSpell(38,"WPP","Counter Spell", SPELL_TYPE_MAGIC_SHIELD,10,0,10, SPELL_DEF_TARGER_SELF, 0, true, true, SPELL_GROUP_COUNTERS, 2));
    Spells.append(new QSpell(39,"WSSc","Ice Storm", SPELL_TYPE_MASSIVE,10,0,14, SPELL_DEF_TARGER_NOBODY, 5, true, false, SPELL_GROUP_ELEMENTS, 4));
    Spells.append(new QSpell(40,"WWFP","Resist Heat", SPELL_TYPE_RESIST,10,4,10, SPELL_DEF_TARGER_SELF, 0, true, false, SPELL_GROUP_ELEMENTS, 4));
    Spells.append(new QSpell(41,"WWP","Protection", SPELL_TYPE_SHIELD,10,1,10, SPELL_DEF_TARGER_SELF, 0, true, true, SPELL_GROUP_PROTECTION, 1));
    Spells.append(new QSpell(42,"WWS","Counter Spell", SPELL_TYPE_MAGIC_SHIELD,10,1,10, SPELL_DEF_TARGER_SELF, 0, true, true, SPELL_GROUP_COUNTERS, 2));
    Spells.append(new QSpell(43,"p","Surrender", SPELL_TYPE_SPEC,-100,0,0, SPELL_DEF_TARGER_SELF, 0, false, true, SPELL_GROUP_PROTECTION, 1));
    Spells.append(new QSpell(44,">","Stab", SPELL_TYPE_STAB,-1,0,0, SPELL_DEF_TARGER_ENEMY, 0, true, true, SPELL_GROUP_DAMAGING, 1));
    Spells.append(new QSpell(SPELL_DISEASE_FDF,"DSFDFc","Disease", SPELL_TYPE_POISON,14,1,17, SPELL_DEF_TARGER_ENEMY, 0, true, false, SPELL_GROUP_ADVANCED, 3));
    Spells.append(new QSpell(SPELL_PARALYSIS_FDF,"FDF","Paralysis", SPELL_TYPE_CONFUSION,13,2,20, SPELL_DEF_TARGER_ENEMY, 0, true, false, SPELL_GROUP_DISRUPTIONS, 2));
    Spells.append(new QSpell(SPELL_PARALYSIS_FDFD,"FDFD","Paralysis", SPELL_TYPE_CONFUSION,13,2,20, SPELL_DEF_TARGER_ENEMY, 0, true, false, SPELL_GROUP_DISRUPTIONS, 2));
}
