    ...
    QObject(parent)
{
    ...
    Spells.append(new QSpell(SPELL_PARALYSIS,"FFF","Paralysis", SPELL_TYPE_CONFUSION,13,2, 20, SPELL_DEF_TARGER_ENEMY, 0, true, true));
    Spells.append(new QSpell(15,"WFPSFW","Summon Giant", SPELL_TYPE_SUMMON_MONSTER,17,4,15, SPELL_DEF_TARGER_SELF, 4, true, false));
    Spells.append(new QSpell(16,"FPSFW","Summon Troll", SPELL_TYPE_SUMMON_MONSTER,15,3,14, SPELL_DEF_TARGER_SELF, 3, true, false));
    ...
    Spells.append(new QSpell(SPELL_PARALYSIS_FDF,"FDF","Paralysis", SPELL_TYPE_CONFUSION,13,2,20, SPELL_DEF_TARGER_ENEMY, 0, true, false));
    Spells.append(new QSpell(SPELL_PARALYSIS_FDFD,"FDFD","Paralysis", SPELL_TYPE_CONFUSION,13,2,20, SPELL_DEF_TARGER_ENEMY, 0, true, false));
}
