    ...
    QObject(parent)
{
    ...
    Spells.append(new QSpell(4,"DFFDD","Lightning Bolt", SPELL_TYPE_DAMAGE,11,1,16, SPELL_DEF_TARGER_ENEMY, 5));
    Spells.append(new QSpell(5,"DFPW","Cure Heavy Wounds", SPELL_TYPE_CURE,10,1,10, SPELL_DEF_TARGER_SELF, 2));
    Spells.append(new QSpell(6,"DFW","Cure Light Wounds", SPELL_TYPE_CURE,10,0,10, SPELL_DEF_TARGER_SELF, 1));
    Spells.append(new QSpell(7,"DFWFd","Blindness", SPELL_TYPE_CONFUSION,13,0,15, SPELL_DEF_TARGER_ENEMY, 0));
    Spells.append(new QSpell(8,"DPP","Amnesia", SPELL_TYPE_CONFUSION,16,1,12, SPELL_DEF_TARGER_ENEMY, 0));
    Spells.append(new QSpell(9,"DSF","Confusion/Maladroitness", SPELL_TYPE_CONFUSION,16,5,12, SPELL_DEF_TARGER_ENEMY, 0));
    Spells.append(new QSpell(SPELL_DISEASE,"DSFFFc","Disease", SPELL_TYPE_POISON,14,1,17, SPELL_DEF_TARGER_ENEMY, 0));
    Spells.append(new QSpell(11,"DWFFd","Blindness", SPELL_TYPE_CONFUSION,13,0,15, SPELL_DEF_TARGER_ENEMY, 0));
    ...
    Spells.append(new QSpell(24,"PSDF","Charm Person", SPELL_TYPE_CONFUSION,15,4,13, SPELL_DEF_TARGER_ENEMY, 0));
    Spells.append(new QSpell(25,"PWPFSSSD","Finger of Death", SPELL_TYPE_DAMAGE,11,0,20, SPELL_DEF_TARGER_ENEMY, 20));
    Spells.append(new QSpell(26,"PWPWWc","Haste", SPELL_TYPE_HASTLE,12,0,10, SPELL_DEF_TARGER_SELF, 0));
    Spells.append(new QSpell(27,"SD","Magic Missile", SPELL_TYPE_DAMAGE,10,0,10, SPELL_DEF_TARGER_ENEMY, 1));
    Spells.append(new QSpell(28,"SPFP","Anti-spell", SPELL_TYPE_CONFUSION,13,0,14, SPELL_DEF_TARGER_ENEMY, 0));
    Spells.append(new QSpell(29,"SPFPSDW","Permanency", SPELL_TYPE_SPEC,13,0,16, SPELL_DEF_TARGER_SELF, 0));
    Spells.append(new QSpell(30,"SPPc","Time Stop", SPELL_TYPE_HASTLE,13,0,10, SPELL_DEF_TARGER_SELF, 0));
    Spells.append(new QSpell(31,"SPPFD","Time Stop", SPELL_TYPE_HASTLE,13,0,10, SPELL_DEF_TARGER_SELF, 0));
    Spells.append(new QSpell(32,"SSFP","Resist Cold", SPELL_TYPE_RESIST,14,1,10, SPELL_DEF_TARGER_SELF, 0));
    Spells.append(new QSpell(33,"SWD","Fear (No CFDS)", SPELL_TYPE_CONFUSION,15,0,12, SPELL_DEF_TARGER_ENEMY, 0));
    Spells.append(new QSpell(34,"SWWc","Fire Storm", SPELL_TYPE_MASSIVE,13,1,14, SPELL_DEF_TARGER_NOBODY, 5));
    Spells.append(new QSpell(35,"WDDc","Clap of Lightning", SPELL_TYPE_DAMAGE,14,0,14, SPELL_DEF_TARGER_ENEMY, 5));
    Spells.append(new QSpell(36,"WFP","Cause Light Wounds", SPELL_TYPE_DAMAGE,14,0,12, SPELL_DEF_TARGER_ENEMY, 2));
    Spells.append(new QSpell(37,"WPFD","Cause Heavy Wounds", SPELL_TYPE_DAMAGE,13,0,13, SPELL_DEF_TARGER_ENEMY, 3));
    Spells.append(new QSpell(38,"WPP","Counter Spell", SPELL_TYPE_MAGIC_SHIELD,10,0,10, SPELL_DEF_TARGER_SELF, 0));
    Spells.append(new QSpell(39,"WSSc","Ice Storm", SPELL_TYPE_MASSIVE,10,0,14, SPELL_DEF_TARGER_NOBODY, 5));
    ...
    Spells.append(new QSpell(SPELL_PARALYSIS_FDFD,"FDFD","Paralysis", SPELL_TYPE_CONFUSION,15,2,12, SPELL_DEF_TARGER_ENEMY, 0));
}
