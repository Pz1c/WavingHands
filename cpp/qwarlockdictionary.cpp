...
void QWarlockDictionary::fillGameDictionary() {
    ...
    fillDictionary("hint_3_1", "", "", "Hint: When you summon a goblin (SFW), cast it at yourself, so you can control it.");
    fillDictionary("hint_3_2", "", "", "Afterwards you can click the goblin to set its target.");
