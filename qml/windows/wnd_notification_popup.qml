...
InfoWindow {
        ...
        Item {
            ...
            Item {
                ...
                Image {
                    ...
                    source: "qrc:/res/notification.png"
            ...
            Text {
                ...
                color: "#10C9F5"
                horizontalAlignment: Text.AlignHCenter
                text: "Get a note when<br>your turn is ready"
            }
            ...
            BtnBig {
                ...
                onClicked: {
                    console.log("main notification popup action");
                    mainWindow.processEscape();
                    mainWindow.gameCore.askPermissions();
                }
            }
            ...
            Text {
                ...
                MouseArea {
                    ...
                    anchors.fill: parent
                    onClicked: {
                        console.log("skip notification popup action");
                        mainWindow.processEscape();
    ...
    function initErrFields() {
        console.log("wnd_notification_popup.initFields.start", JSON.stringify(mainWindow.gERROR));

        //saClick.start();
        mainWindow.gERROR = {};
        console.log("wnd_notification_popup.initFields.end", ltTitle.text, ltShortDesc.text);
    }
